...
import { getOrders, createOrder, getUserOrders, getOrderStats, getOrderById, updateOrderStatus, deleteOrder } from "../controllers/OrderController.js";
...
router.delete("/order/:orderId", protect, authorize('delete', 'order'), deleteOrder); 
